...
////// Lighting:
////// Emissive:
                float3 node_8804 = (_MainTex_var.rgb*i.vertexColor.rgb);
                float3 emissive = node_8804;
